...
<html>
    <head>
            ...
            <!-- Theme style -->
            <link href="{{asset('asset/css/AdminLTE.min.css')}}" rel="stylesheet" type="text/css" />
            <!-- AdminLTE Skins. Choose a skin from the css/skins
                folder instead of downloading all of them to reduce the load. -->
            <link href="{{asset('asset/css/skins/_all-skins.min.css')}}" rel="stylesheet" type="text/css" />
            <!-- iCheck -->
  ...
  <body class="skin-blue">
        <div class="wrapper">
            <header class="main-header">
                <!-- Logo -->
                <a href="index2.html" class="logo"><b>punjab</b>school</a>
              <!-- Header Navbar: style can be found in header.less -->
                ...
                <div class="navbar-custom-menu">
                    ...
                    <li class="dropdown messages-menu">
                        ...
                        <li>
                            ...
                            <li><!-- start message -->
                                <a href="#">
                                <div class="pull-left">
                                    <img src="{{asset('asset/img/user2-160x160.jpg')}}" class="img-circle" alt="User Image"/>
                                </div>
                                <h4>
                                    Support Team
                            ...
                            <li>
                                <a href="#">
                                <div class="pull-left">
                                    <img src="{{asset('asset/img/user3-128x128.jpg')}}" class="img-circle" alt="user image"/>
                                </div>
                                <h4>
                            ...
                            <li>
                                <a href="#">
                                <div class="pull-left">
                                    <img src="{{asset('asset/img/user4-128x128.jpg')}}" class="img-circle" alt="user image"/>
                                </div>
                                <h4>
                                    Developers
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="{{asset('asset/img/user2-160x160.jpg')}}" class="user-image" alt="User Image"/>
              ...
              <ul class="sidebar-menu">
                ...
                <li class="active treeview">
                  ...
                  <ul class="treeview-menu">
                     ...
                     <li class="active"><a href="{{route('grocery.createGrocery')}}"><i class="fa fa-circle-o"></i>Creat Grocery</a></li>
                    <li class="active"><a href="{{route('grocery.showGrocery')}}"><i class="fa fa-circle-o"></i>Show Grocery</a></li>
    ...
    <!-- jQuery 2.1.3 -->
    <script src="{{asset('asset/plugins/jQuery/jQuery-2.1.3.min.js')}}"></script>
    <!-- jQuery UI 1.11.2 -->
    ...
    <script src="{{asset('asset/js/pages/dashboard.js')}}" type="text/javascript"></script>

    <!-- AdminLTE for demo purposes -->
    <script src="{{asset('asset/js/demo.js')}}" type="text/javascript"></script>
